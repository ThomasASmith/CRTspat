...
The current version (0.1.0.9000) is for *testing* and has been developed mainly on data that are proportions. It is likely to need some further to ensure the correct outputs with other kinds of outcome.
...
[6. Use Case 6: Thematic mapping of the geography of a CRT](Usecase6.html)
...
`
Some of the functionality depends on [R-INLA](https://www.r-inla.org/) and [jagsUI](https://cran.r-project.org/web/packages/jagsUI/index.html) which you may want to intall these packages too.
