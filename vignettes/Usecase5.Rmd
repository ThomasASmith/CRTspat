...
The function `CRTanalysis` is a wrapper for implementations of several statistical analysis packages set up
to analyse geographically structured CRT data:
...
Real field trials very often entail complications that are not catered for any of the analysis options in
by the likely to
