...
# Data frame of input contamination interval
...
## Analysis by simulated contamination interval

An analogous analysis, to that of performance relative to efficacy, can be carried out to explore the effect of the simulated contamination interval.
...
The relationships between the simulated contamination interval and the corresponding proportion of the locations in the trial (Figure 7.2).

<p>
    <img src="example7e.r-1.png" > <br>
    <em>Fig 7.2 Proportion of locations in simulated contamination interval
...
<p>
    ...
    <em>Fig 7.3 Performance of t-test by contamination interval
$\color{purple}{\textbf{----}}$ : ratio of power:nominal power;
$\color{green}{\textbf{----}}$ :type II error rate;
$\color{blue}{\textbf{----}}$ : bias.
    </em>
