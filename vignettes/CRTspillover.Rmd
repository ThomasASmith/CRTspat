...
| Method | Description | Linear predictor| Allowance for Clustering | Allowance for Spillover | Reference | 
|----------:|:---------------|---------------|:--------------------:|
|'empirical' | Comparison of empirical
event rates by arms |$\tilde{E}_{s} = 1- \frac{\tilde{p}_{I}}{\tilde{p}_{C}}$|NO | NO |[Multerer *et al.* (2021a)](https://trialsjournal.biomedcentral.com/articles/10.1186/s13063-021-05543-8) |  
|'piecewise_linear' | 
|'logit' |
|'sigmoid' |
|'GEE' |
