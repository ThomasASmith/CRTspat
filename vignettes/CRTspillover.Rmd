...
![image info](./vignettes/workflow.svg){ width=100% }
...
![plot of chunk example1.r](/vignettes/example1.r-1.png)
...
![plot of chunk example1.r](/vignettes/example1.r-2.png)
...
![plot of chunk example1.r](/vignettes/example1.r-3.png)
...
## DIC:  1554.311  Contamination parameter:  19.1601   DIC:  1553.895  Contamination parameter:  30.9399   DIC:  1553.771  Contamination parameter:  38.22021   DIC:  1553.743  Contamination parameter:  43.32379   DIC:  1553.728  Contamination parameter:  43.74677   DIC:  1553.75  Contamination parameter:  46.13529   DIC:  1553.76  Contamination parameter:  44.6588   DIC:  1553.74  Contamination parameter:  43.7801   DIC:  1553.766  Contamination parameter:  43.55635   DIC:  1553.734  Contamination parameter:  43.67403   DIC:  1553.762  Contamination parameter:  43.71343   DIC:  1553.726  Contamination parameter:  43.74677   Starting full INLA analysis                  
## Analysis model:  SPDE  Contamination option:  L 
## Estimated Proportions- Control:  0.431  (95% CL:  0.38 0.481 ) - Intervention:  0.288  (95% CL:  0.247 0.332 )
## Efficacy:  0.331  (95% CL:  0.35 0.31 )
## Contamination Range:  0.1642673
```
...
![plot of chunk example2.r](/vignettes/example2.r-1.png)

```r
Plot_CRTmap(analysis=results6b,trial=test6b,showProportion = TRUE)
```

![plot of chunk example2.r](/vignettes/example2.r-2.png)
...
## =====================    ANALYSIS OF CLUSTER RANDOMISED TRIAL    =================
## Estimating scale parameter for contamination range 
## DIC:  1558.49  Contamination parameter:  19.1601   DIC:  1559.369  Contamination parameter:  30.9399   DIC:  1558.002  Contamination parameter:  11.87979   DIC:  1558.319  Contamination parameter:  7.380312   DIC:  1558.011  Contamination parameter:  12.64858   DIC:  1557.979  Contamination parameter:  11.84646   DIC:  1557.967  Contamination parameter:  10.14054   DIC:  1557.961  Contamination parameter:  10.98491   DIC:  1557.964  Contamination parameter:  10.76625   DIC:  1557.966  Contamination parameter:  11.31399   DIC:  1557.986  Contamination parameter:  11.01824   DIC:  1557.986  Contamination parameter:  10.95157   DIC:  1557.962  Contamination parameter:  10.98491   Starting full INLA analysis                  
## Analysis model:  SPDE  Contamination option:  L 
## Estimated Proportions- Control:  0.455  (95% CL:  0.409 0.501 ) - Intervention:  0.282  (95% CL:  0.246 0.321 )
## Efficacy:  0.381  (95% CL:  0.4 0.36 )
## Contamination Range:  0.6620471
```
...
![plot of chunk example3.r](/vignettes/example3.r-1.png)
...
## 
## =====================    ANALYSIS OF CLUSTER RANDOMISED TRIAL    =================
## Analysis model:  GEE  Contamination option:  X 
## Estimated Proportions- Control:  0.578  (95% CL:  0.491 0.661 ) - Intervention:  0.372  (95% CL:  0.302 0.448 )
## Efficacy:  0.357  (95% CL:  0.179 0.496 )
...
## 
## =====================    ANALYSIS OF CLUSTER RANDOMISED TRIAL    =================
## Analysis model:  ML  Contamination option:  L 
## Estimated Proportions- Control:  0.277  (95% CL:  NA ) - Intervention:  0.361  (95% CL:  NA )
## Efficacy:  -0.303  (95% CL:  NA )
## Contamination Range:  5.62132
```
