...
#' @param showDistance logical: determining whether smoothed raster of the distance from nearest discordant location is produced
#' @param showProportion logical: determining whether a smoothed raster of the fitted proportion is produced
